                ...
                if imgrect1.collidepoint(mouse_pos):
                    ...
                    while True:
                        ...
                        if os.path.isfile(x):
                            ...
                            file.close()
                            SceneNo(int(SceneNum), int(LineNum)+1,0)                            
...
def Scene2():
    ...
    if LineNum == 10:
        ...
        if LineNum == 1:
            ...
            img3, imgrect3 = ButtonResize('../Char/Bulb.png',(360,310),(910,400),screen)
            while True:
                for event in pygame.event.get():            
                    if event.type == pygame.QUIT:
                        pygame.quit()
...
def Scene3():
    ...
    if LineNum == 9:
        Sc2_Mal(myfont)
        Line1("Well, have you fed them yet?")
    elif LineNum == 8:
        Store()
    elif LineNum == 7:
        img2, imgrect2 = ButtonResize('../Img/otextbox.png',(1180,600),(200,400),screen)
